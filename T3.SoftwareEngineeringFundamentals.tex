...
\begin{frame}
  ...
  What if we could design a system where new features \textbf{do not} propagate \textbf{any} change at all?
  \newline
...
\begin{frame}[fragile]
  ...
  \texttt{Paypal} doesn't implement \texttt{getBankNumber}, \texttt{Visa} and \texttt{Mastercard} don't implement \texttt{getInstantToken}. We can fix it by adding an extra interface inheritance layer.
  \newline
