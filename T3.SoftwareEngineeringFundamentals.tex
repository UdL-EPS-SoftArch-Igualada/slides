...
\section{Block A - Re-discovering Software Engineering}
\begin{frame}
...
\begin{frame}
  ...
  \begin{block}{Axiom A2: Labor Cost}
    The cost (time and money) of a change roughly proportional to the amount of code added and modified. This includes writing the new code, testing, debugging, etc.
  \end{block}
...
\begin{frame}
  \begin{exampleblock}{Corollary: \textbf{Liskov Substitution Principle (LSP)}}
    A superclass must be replacable by any of it subclasses without ever breaking.
  \end{exampleblock}
  \begin{columns}
    \column{.45\linewidth}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    {\raggedleft
    \footnotesize
    - Joel Spolsky, co-creator of Trello \& StackOverflow
    \par}
