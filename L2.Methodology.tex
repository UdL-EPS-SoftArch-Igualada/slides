...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[width=1\textwidth]{images/diagrams/controller-service-repository.pdf}
...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[width=0.77\textwidth]{images/diagrams/spring-data-rest.pdf}
...
\begin{frame}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \centering
    \begin{figure}
      \includegraphics[height=0.82\textheight]{images/generated-records-endpoints.png}
    \end{figure}

    \column{0.5\textwidth}
    \centering
    \begin{figure}
      \includegraphics[height=0.82\textheight]{images/generated-records-endpoint-put.png}
    \end{figure}
  \end{columns}
...
\begin{frame}
  ...
  \begin{enumerate}
    \item Write a simple \textbf{Repository} class for the same domain models you created last week.
    \begin{itemize}
      \item You may need to update your model to add the required persistence annotations.
    \end{itemize}
    ...
    \begin{itemize}
      ...
      \item See the \href{https://github.com/UdL-EPS-SoftArch-Igualada/spring-template/blob/main/src/test/resources/features/ManageRecord.feature}{template repository} for examples.
    \end{itemize}
