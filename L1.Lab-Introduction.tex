...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{block}{About our server}
      The server is located in Nuremberg, Germany. It has 4 CPU cores, 8 GB of RAM and 80 GB of SSD storage.
    \end{block}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \column{0.15\textwidth}
        \href{https://www.tresgriferia.com/}{\includegraphics[width=1\textwidth]{images/L1/tres-griferia.png}}
  \end{columns}
...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \item \textbf{Fork} the backend (Java) repository. Be careful \textbf{not} to fork the \textit{template} repo.
    \item Have a look around the repo.
  \end{enumerate}
\end{frame}
