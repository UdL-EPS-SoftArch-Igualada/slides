...
\begin{frame}
  ...
  \begin{itemize}
    \item Software Engineers work in \textbf{teams} to solve \textbf{complex problems} with \textbf{real stakes} (potentially human lives\footnote{\url{https://en.wikipedia.org/wiki/Therac-25}}).
    \item Complex software problems require different \textbf{architectural patterns} and \textbf{development strategies} compared to simple software.
  \end{itemize}
