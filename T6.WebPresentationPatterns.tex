...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{itemize}
      ...
      \item \textbf{Controller}: Handles user input, coordinates the Model and View.
    \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item \textbf{Model-View-ViewModel (MVVM)}\footnote{The MVVM pattern has inspired several modern frontend frameworks like Angular and React.}: The ViewModel exposes observable state that the View binds to declaratively. Also known as \textit{Presentation Model}.
  \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    \item \textbf{Template View}: An almost-HTML page structure that mixes static markup with
      executable code snippets for dynamic content.
...
\begin{frame}
  ...
  \textbf{Advantages:}
  \begin{itemize}
    \item Fast \textit{Time to First Paint} (SSR benefit).
...
\begin{frame}
  ...
  \begin{tabularx}{\textwidth}{l X X X X}
    ...
    Interactivity  & \colBad{Low}      & \colBad{Low}      & \colGood{High}    & \colGood{High}  \\
